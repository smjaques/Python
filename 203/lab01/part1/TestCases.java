...
public class TestCases
{
   ...
   {
      assertEquals(12.5, SimpleIf.max(12.4, 12.5), DELTA);
   }
   ...
   public void testSimpleArray3()
   {
      assertArrayEquals(
         new int[] {4, 16, 81},
         SimpleArray.squareAll(new int[] {2, 4, 9}));
   }
   ...
   {
      List<Integer> input = 
         new LinkedList<Integer>(Arrays.asList(new Integer[] {2, 5, 6}));
      List<Integer> expected =
         new ArrayList<Integer>(Arrays.asList(new Integer[] {4, 25, 36}));
   ...
   {
      assertFalse(BetterLoop.contains(new int[] {33, 45, 324, 5432}, 1));
   }
   ...
   {
      List<String> expected = Arrays.asList("Sydney", "Gabi");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();

      courseListsByStudent.put("Sydney",
         Arrays.asList(
            new Course("CPE 123", 4),
            new Course("CPE 101", 4),
            new Course("CPE 202", 4),
