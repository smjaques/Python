...
# ---- empty ----
    def test_empty(self):
        self.assertEqual(empty_list(), List([None, None, None, None, None, None, None, None, None, None], 0, 10))
...
# ---- length ----
    def test_length(self):
        self.assertEqual(length([1, 2, None]), 3)
...
# ---- set ----
    def test_set(self):
        ...
        with self.assertRaises(IndexError):
            set([1, None, None], -4, -9)
    def test_set2(self):
        self.assertEqual(set([64, 343, 54, 76], 1, 0), [64, 0, 54, 76])
    def test_set3(self):
        self.assertEqual(set([12, 54, None], 0, 567), [567, 54, None])
